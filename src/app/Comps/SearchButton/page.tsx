        ...
        >
          <div className="w-full max-w-lg overflow-hidden rounded-lg bg-white shadow-xl">
            <div className="flex items-center border-b border-gray-200 px-6 py-4">
              <h2 id="search-button-modal-title" className="w-full">
                <input
                  ref={inputRef}
                  type="search"
                  placeholder="Search"
...
const searchButtonCode2 = `'use client'
    ...
    <SidebarInset>
        ...
        <div className="flex items-center gap-2 px-4">
          ...
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>Search Buttons</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>
      ...
      <div className="min-h-0 flex-1 overflow-y-auto border-t border-slate-300 bg-slate-100">
        <div className="mx-auto w-full max-w-305 px-4 py-4">
          ...
          <div className="mb-5">
            <ComponentPreview title="Search button" detail="Open a search dialog with a keyboard shortcut and recent results." code={searchButtonCode1} language="tsx">
              <SearchButtonExample />
            </ComponentPreview>
          </div>

          <div className="mb-5">
            <ComponentPreview title="Custom shortcut" detail="A command-palette-style trigger that listens for Ctrl/Cmd + I." code={searchButtonCode2} language="tsx">
