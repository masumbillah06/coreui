...
export default function CoreUIBanner() {
  return (
    <div className="mb-4 rounded border-2 border-amber-600 bg-amber-100">
      <div className="flex flex-wrap items-center p-3 px-4 xl:flex-nowrap">
        ...
        <div className="mt-3 px-2 flex w-full flex-col md:w-auto xl:mt-0">
          <a
            ...
            className="inline-flex items-center justify-center text-nowrap rounded bg-amber-600 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-blue-700"
          >
